...

            {
                projects.length === 0 ? (
                    <div className='text-center py-20'>
                        <div className='w-16 h-16 mx-auto mb-4 rounded-lh bg-muted flex items-center justify-center'>
                            ...
                            <Link
                                ...
                                <div className='space-y-3'>
                                    <div className='aspect-4/3 rounded-lg overflow-hidden bg-muted'>
                                        {project.thumbnail ? (
                                            <Image src={project.thumbnail} alt={project.name} height={200} width={300}
